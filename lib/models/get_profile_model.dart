class GetProfileModel {
  ...
  GetProfileModel({this.success, this.data, this.images});
...
class User {
  ...
  User.fromJson(Map<String, dynamic> json) {
    ...
    planActivated = json['plan_activated'];
  ...
  Map<String, dynamic> toJson() {
    ...
    data['plan_activated'] = planActivated;
