...
import 'forgot_password_change.dart';
                    ...
                    child: Container(
                      ...
                      child: Form(
                        ...
                        child:  Column(
                            ...
                            TextFormField(
                              ...
                              validator: (value) {
                               if (value == null || value.isEmpty) {
                                 return 'Enter a Valid Email address & Mobile Number';
                               }
                               if (value.length <=5) {
                                 return 'Enter a Valid Email address & Mobile Number';
                               }
                          ...
                          //         return 'Confirm password and new passowrd must be same';
                          //       }
                          //       return null;
                          //     },
                          //     keyboardType: TextInputType.emailAddress,
                            ...
                            Center(
                             ...
                             if(_formKey.currentState!.validate()) {
                               ...
                               bool ?res = await authController
                                   .postPhoneNumberApi(
                                   mobile: password.text, context: context);
                               if (res == true) {
