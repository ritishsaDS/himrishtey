...
class RejectedInterestList extends StatefulWidget {
  const RejectedInterestList({Key? key}) : super(key: key);

  @override
  State<RejectedInterestList> createState() => _RejectedInterestListState();
}

class _RejectedInterestListState extends State<RejectedInterestList> {
  ...
  void initState() {
    ...
    interestListController?.rejectedInvitationList(context);
