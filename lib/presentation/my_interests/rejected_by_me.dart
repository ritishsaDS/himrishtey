...
class RejectedMeInterestList extends StatefulWidget {
  const RejectedMeInterestList({Key? key}) : super(key: key);

  @override
  State<RejectedMeInterestList> createState() => _RejectedMeInterestListState();
}

class _RejectedMeInterestListState extends State<RejectedMeInterestList> {
  ...
  void initState() {
    ...
    interestListController?.rejectedmeInvitationList(context);
