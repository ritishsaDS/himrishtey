...
class SentInterestList extends StatefulWidget {
  const SentInterestList({Key? key}) : super(key: key);

  @override
  State<SentInterestList> createState() => _SentInterestListState();
}

class _SentInterestListState extends State<SentInterestList> {
  ...
  void initState() {
    ...
    interestListController?.sentInvitationList(context);
